	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="SEX" prop="xingbie" >
					<el-select :disabled="ro.xingbie" v-model="ruleForm.xingbie" placeholder="请选择SEX" >
						<el-option
				...
				<el-form-item v-else class="input" label="SEX" prop="xingbie" >
					<el-input v-model="ruleForm.xingbie"
						placeholder="SEX" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="PHONE" prop="shouji" >
					<el-input v-model="ruleForm.shouji" placeholder="PHONE" clearable  :readonly="ro.shouji"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="PHONE" prop="shouji" >
					<el-input v-model="ruleForm.shouji" placeholder="PHONE" readonly></el-input>
				</el-form-item>
		...
		data() {
			var validateMobile = (rule, value, callback) => {
				if(!value){
					...
					callback(new Error("请输入正确的PHONE号码"));
				} else {
					callback();
				}
			};
