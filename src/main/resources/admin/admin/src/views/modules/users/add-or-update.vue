<template>
	<div class="addEdit-block">
		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="User名" prop="username" >
					<el-input v-model="ruleForm.username" placeholder="User名" clearable  :readonly="ro.username"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="User名" prop="username" >
					<el-input v-model="ruleForm.username" placeholder="User名" readonly></el-input>
				</el-form-item>
	...
	export default {
		data() {
			return {
				...
				rules: {
					username: [
						{ required: true, message: 'User名不能为空', trigger: 'blur' },
					],
					password: [
