<template>
	<div class="main-content" :style='{"padding":"60px 20px","margin":"0","fontSize":"16px"}'>
		...
		<div v-if="!showFlag" style="width: 100%;">
			<el-form :style='{"margin":"0 0px 0px"}' :inline="true" :model="searchForm" class="center-form-pv">
				<el-row :style='{"width":"100%","padding":"10px","flexWrap":"wrap","background":"none","display":"flex"}'>
					<div :style='{"margin":"0 10px 20px 0","display":"flex"}'>
						<label :style='{"border":"1px solid #CBCBCB","padding":"0 10px","margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#000","textAlign":"center","display":"inline-block","borderRadius":"10px","background":"#fff","width":"auto","lineHeight":"34px","fontSize":"inherit","fontWeight":"500","height":"34px"}' class="item-label">是否回复</label>
					...
					<div :style='{"margin":"0 10px 20px 0","display":"flex"}'>
						<label :style='{"border":"1px solid #CBCBCB","padding":"0 10px","margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#000","textAlign":"center","display":"inline-block","borderRadius":"10px","background":"#fff","width":"auto","lineHeight":"34px","fontSize":"inherit","fontWeight":"500","height":"34px"}' class="item-label">是否已读</label>
				...
				<el-table
					...
					<el-table-column
						...
						<template slot-scope="scope">
							<el-button
								type="text"
								:style='{"border":"1px solid #D8D8D8","cursor":"pointer","padding":"0 5px","margin":"0 5px 5px 0","color":"#000000","borderRadius":"2px","background":"none","width":"auto","fontSize":"16px","fontWeight":"400","height":"32px"}'
								size="small"
