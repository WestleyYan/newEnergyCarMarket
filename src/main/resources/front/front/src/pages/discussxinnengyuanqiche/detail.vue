			...
			<div class="attr">
				<div class="info">
					...
					<div class="btn_box">
						...
						<el-button class="delBtn" v-if="btnAuth('discussxinnengyuanqiche','DELATE')" @click="delClick">DELATE</el-button>
					</div>
				</div>
			</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			// DELATE
			async delClick(){
				await this.$confirm('是否DELATE此New Energy Vehicles评论表？') .then(_ => {
