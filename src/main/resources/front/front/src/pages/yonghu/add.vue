<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="NAME" prop="xingming">
				<el-input v-model="ruleForm.xingming" 
					placeholder="NAME" clearable :disabled=" false  ||ro.xingming"></el-input>
			</el-form-item>
			<el-form-item class="add-item"  label="SEX" prop="xingbie">
				<el-select v-model="ruleForm.xingbie" placeholder="请选择SEX" :disabled=" false  ||ro.xingbie" >
					<el-option
			...
			<el-form-item class="add-item" label="PHONE" prop="shouji">
				<el-input v-model="ruleForm.shouji" 
					placeholder="PHONE" clearable :disabled=" false  ||ro.shouji"></el-input>
			</el-form-item>
