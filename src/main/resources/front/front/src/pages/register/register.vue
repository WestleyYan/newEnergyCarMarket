	...
	<div>
		...
		<div class="container">
			<el-form class='rgs-form animate__animated animate__' v-if="pageFlag=='register'" ref="registerForm" :model="registerForm" :rules="rules">
				<div class="rgs-form2">
					<div class="title">New Energy Vehicle Sales System</p></div>
					...
					<el-form-item class="list-item" v-if="tableName=='yonghu'" prop="xingming">
						<div class="label" :class="changeRules('xingming')?'required':''">NAME：</div>
						<el-input v-model="registerForm.xingming"  placeholder="请输入NAME" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='yonghu'" prop="xingbie">
						<div class="label" :class="changeRules('xingbie')?'required':''">SEX：</div>
						<el-select v-model="registerForm.xingbie" placeholder="请选择SEX" >
							<el-option
					...
					<el-form-item class="list-item" v-if="tableName=='yonghu'" prop="shouji">
						<div class="label" :class="changeRules('shouji')?'required':''">PHONE：</div>
						<el-input v-model="registerForm.shouji"  placeholder="请输入PHONE" />
					</el-form-item>
